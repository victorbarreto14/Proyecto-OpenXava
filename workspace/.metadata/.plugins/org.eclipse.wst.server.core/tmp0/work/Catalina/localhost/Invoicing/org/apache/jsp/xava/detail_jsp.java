...
private boolean hasFrame(MetaMember m, View view) { 
  ...
  static {
    ...
    _jspx_dependants.put("/xava/editorIcons.jsp", Long.valueOf(1450136919000L));
...
if (view.isEditable() || 
 ...
 if (p.isKey()) { 
      ...
      // /xava/editorIcons.jsp(13,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
 ...
 if (errors.memberHas(p)) { 
      ...
      // /xava/detail.jsp(285,14) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_xava_005fid_005f1.setName(colletionHeaderId);
      ...
      // /xava/detail.jsp(307,13) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
...
if (view.hasSections()) { // IF Has Sections
	...
	if (!onlySections && view.isSubview() && !view.isFrame()) {  // IF Not Only Sections and Subview and Not Frame
      ...
      // /xava/detail.jsp(423,10) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
